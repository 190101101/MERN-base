...
const Cart = () => {
  ...
  return (
    <>
      ...
      <div className="px-6">
        <Table rowKey={"_id"} dataSource={cart.cartItems} columns={columns} bordered pagination={true} scroll={{
            x: 1200,
            y: 300,
          }}/>
        ...
        <div className="cart-total flex justify-end mt-4">
          <Card className="w-72">
            ...
            <Button onClick={showModal} className="mt-4 w-full" type="primary" size="large" disabled={cart.cartItems.length === 0}>Order</Button>
          </Card>
        </div> 
      </div>
